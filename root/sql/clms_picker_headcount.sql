Drop table if exists clms_data;
create local temp table clms_data on commit preserve rows as (
...
where labor_area in ('Outbound - Multis', 'Outbound - Singles', 'Singles', 'Multis','Autopack') ------ change the as per the labor area required
--and labor_function = 'Multis Ground Picking'  --- change as per the function with the labor area
)
...
where warehouse in ('AVP1') ---- change/Add FC
and time_segment between '2025-03-05 11:00:00' and '2025-03-05 12:00:00'
